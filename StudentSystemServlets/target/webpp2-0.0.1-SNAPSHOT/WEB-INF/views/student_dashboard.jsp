...
<table>
    ...
    <tr>
        <td>
            <form action="/viewGrades" method="GET">
                <input type="hidden" name="user_id" value="${user_id}">
                <input type="hidden" name="role" value="STUDENT">
                <button type="submit">View Grades</button>
            </form>
        </td>
        <td class="description">view your course grades</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="description">view the courses you are taking</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="description">enroll a course</td>
    </tr>
</table>
</body>
</html>